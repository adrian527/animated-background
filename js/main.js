...
class Sky {
    ...
    updateStars() {
        this.stars.forEach(star => {
            ...
            star.y -= star.speed * (this.delta / 16) * (this.width / 2 - star.x) / 1000;
    ...
    drawConstellation() {
        ...
        if (starCount - 3 < 0) return;

        const firstStar = stars[0];
        const lastStar = stars[starCount - 1];
